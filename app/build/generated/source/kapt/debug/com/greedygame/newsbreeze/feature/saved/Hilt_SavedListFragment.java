...
public abstract class Hilt_SavedListFragment<VB extends ViewDataBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SavedListFragment_GeneratedInjector) this.generatedComponent()).injectSavedListFragment(UnsafeCasts.<SavedListFragment>unsafeCast(this));
    }
  }
