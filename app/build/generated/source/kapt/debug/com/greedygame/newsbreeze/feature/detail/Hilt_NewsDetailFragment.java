...
public abstract class Hilt_NewsDetailFragment<VB extends ViewDataBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewsDetailFragment_GeneratedInjector) this.generatedComponent()).injectNewsDetailFragment(UnsafeCasts.<NewsDetailFragment>unsafeCast(this));
    }
  }
