...
public abstract class Hilt_NewsFragment<VB extends ViewDataBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewsFragment_GeneratedInjector) this.generatedComponent()).injectNewsFragment(UnsafeCasts.<NewsFragment>unsafeCast(this));
    }
  }
