...
public abstract class FragmentNewsBinding extends ViewDataBinding {
  ...
  @NonNull
  public final CardView savedItems;
  ...
  protected FragmentNewsBinding(Object _bindingComponent, View _root, int _localFieldCount,
      CardView cardView, ConstraintLayout header, ProgressBar progressBar,
      RecyclerView recyclerView, Button retryButton, CardView savedItems, EditText searchBar,
      TextView textView) {
